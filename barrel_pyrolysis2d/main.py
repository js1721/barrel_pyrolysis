...
fuel-lean root of k_eff = 0.98 at mu = 0.5 cm^-1 (with the exchange rate
matched to 1D, see neutronics._build_system); this drum's k peaks near
1.17 around v1 ~ 0.5 (optimum moderation). A smaller 20 x 40 cm
...
if __name__ == "__main__":
    cfg = Config(R=28.6, H=88.0, Nr=22, Nz=64, mu=0.5, v1=0.18746267637623532,
